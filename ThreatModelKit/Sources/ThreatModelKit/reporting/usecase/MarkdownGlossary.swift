...
public enum MarkdownGlossary {
    ...
    public static let entries: [(word: String, meaning: String)] = [
        ...
        ("Scope", "what the model covers: the use cases, the users and what the model leaves out"),
        ("Use cases", "what a person does with the system"),
        ("Users", "the people who use the system, and what each one reaches"),
        ...
        ("Threat actors", "the adversaries this assessment is written against"),
