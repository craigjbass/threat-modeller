...
public enum MarkdownGlossary {
    ...
    public static let entries: [(word: String, meaning: String)] = [
        ...
        ("If the proposed are in place", "the residual score with every proposed mitigation counted as in place"),
        ...
        ("Proposed mitigations", "a mitigates edge the team plans and has not put in place yet"),
